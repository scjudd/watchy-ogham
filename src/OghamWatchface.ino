...
class OghamWatchface : public Watchy {
  public:
    OghamWatchface(const watchySettings& s) : Watchy(s) {}

    void drawWatchFace() {
      display.fillScreen(GxEPD_WHITE);
      display.drawBitmap(0, 0, epd_bitmap_Watchy_Ogham, SCREEN_WIDTH, SCREEN_HEIGHT, GxEPD_WHITE, GxEPD_BLACK);
...
OghamWatchface watchy(settings);
